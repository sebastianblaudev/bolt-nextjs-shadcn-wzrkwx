...
import { Package, DollarSign, Trash2, Pencil } from "lucide-react";
...
export default function Buy() {
  ...
  const handleAddToCart = () => {
    ...
    const newItem: CartItem = {
      ...
      total: product.buyPrice * parsedQuantity,
    };
      ...
      cart.map((item) =>
        item.cartId === editingItem.cartId
          ? {
              ...
              total: item.buyPrice * newQuantity,
            }
          : item
      )
    );
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Comprar Productos</h1>
        <Link href="/">
      ...
      <PriceEditDialog
        ...
        currentPrice={editingItem?.buyPrice || 0}
        type="buy"
      />
